...
const BADGES: BadgeSeed[] = [
  ...
  // Engagement - likes received
  {
    ...
    tier: 'BRONZE',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'like_received_count',
    triggerThreshold: 10,
    displayOrder: 200,
  },
  {
  ...
  },
  {
    slug: 'popular-gold',
    name: 'Popular',
    description: 'Receive 500 likes on your photos',
    category: 'ENGAGEMENT',
    tier: 'GOLD',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'like_received_count',
  ...
  {
    slug: 'popular-platinum',
    name: 'Popular',
    description: 'Receive 1000 likes on your photos',
    category: 'ENGAGEMENT',
    tier: 'PLATINUM',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'like_received_count',
  ...
  {
    slug: 'commentator-bronze',
    name: 'Commentator',
    description: 'Write 10 comments',
    category: 'ENGAGEMENT',
    tier: 'BRONZE',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'comment_count',
    triggerThreshold: 10,
    displayOrder: 210,
  },
  {
    slug: 'commentator-silver',
    name: 'Commentator',
  ...
  {
    slug: 'commentator-gold',
    name: 'Commentator',
    description: 'Write 200 comments',
    category: 'ENGAGEMENT',
    tier: 'GOLD',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'comment_count',
  ...
  // Community
  {
    ...
    tier: 'BRONZE',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'community_join_count',
    triggerThreshold: 1,
    displayOrder: 300,
  },
  {
  ...
  },
  {
    ...
    tier: 'GOLD',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'community_created_count',
    triggerThreshold: 1,
    displayOrder: 302,
  },
  ...
  // Streak
  {
    ...
    tier: 'BRONZE',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'upload_streak_days',
    triggerThreshold: 7,
    displayOrder: 400,
  },
  {
    slug: 'streak-silver',
    name: 'Dedicated',
    description: 'Upload photos 30 days in a row',
    category: 'STREAK',
    tier: 'SILVER',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'upload_streak_days',
  ...
  },
  {
    slug: 'streak-gold',
    name: 'Dedicated',
    description: 'Upload photos 90 days in a row',
    category: 'STREAK',
    tier: 'GOLD',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'upload_streak_days',
  ...
  // Diversity - airports
  {
    slug: 'explorer-bronze',
    name: 'Globe Trotter',
    description: 'Photograph at 5 different airports',
    category: 'DIVERSITY',
    tier: 'BRONZE',
    triggerType: 'AUTOMATIC',
  ...
  {
    slug: 'explorer-silver',
    name: 'Globe Trotter',
    description: 'Photograph at 25 different airports',
    category: 'DIVERSITY',
    tier: 'SILVER',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'unique_airport_count',
  ...
  },
  {
    slug: 'explorer-gold',
    name: 'Globe Trotter',
    description: 'Photograph at 50 different airports',
    category: 'DIVERSITY',
    tier: 'GOLD',
    triggerType: 'AUTOMATIC',
    triggerMetric: 'unique_airport_count',
  ...
  // Awards (manually granted) — repeatable so the same photographer can
  // win across multiple periods/photos.
  {
    slug: 'photo-of-day',
    name: 'Photo of the Day',
    description: 'Had the most liked photo of the day',
    category: 'AWARD',
    tier: 'GOLD',
    triggerType: 'AWARDED',
    displayOrder: 600,
  ...
  },
  {
    ...
    description: 'Had the most liked photo of the week',
    category: 'AWARD',
    tier: 'GOLD',
    triggerType: 'AWARDED',
    displayOrder: 601,
  ...
  },
  {
    ...
    description: 'Had the most liked photo of the month',
    category: 'AWARD',
    tier: 'PLATINUM',
    triggerType: 'AWARDED',
    displayOrder: 602,
  ...
  },
  {
    slug: 'editors-pick',
    name: "Editor's Pick",
    description: 'Selected by an editor for outstanding quality',
    category: 'AWARD',
    tier: 'GOLD',
    triggerType: 'AWARDED',
    displayOrder: 603,
  ...
  },
  {
    ...
    description: 'Hand-picked by an admin as a standout photo of the week',
    category: 'AWARD',
    tier: 'GOLD',
    triggerType: 'AWARDED',
    displayOrder: 604,
...
// `tsx prisma/seed-badges.ts`. When imported by seed.ts, the caller
// supplies its own PrismaClient and lifecycle.
