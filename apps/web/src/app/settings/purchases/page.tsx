      ...
      <div className={styles.inner}>
        ...
        {fetching ? (
          ...
          <div className={styles.empty}>
            ...
            <p className={styles.emptyText}>When you buy a photo, it will appear here.</p>
            ...
            {purchases.map(
              ({
                ...
                node: {
                  ...
                  seller: { username: string; profile?: { displayName?: string | null } | null };
                };
              }) => {
                ...
                const date = new Date(node.createdAt).toLocaleDateString(undefined, {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric',
                });
                return (
                  <div key={node.id} className={styles.purchaseCard}>
                    ...
                    <div className={styles.purchaseAmount}>${node.amountUsd}</div>
                  </div>
                );
              },
            )}
